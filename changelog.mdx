...
<Update label="2026-05-20" tags={["Stream","(Improvement)"]}>
  ## Stream Video storage size info API & Dashboard update
  ...
  This feature has been added to the Stream dashboard for granular video storage usage breakdown via the (i) infomation icon - selectable within your video library or the video page. [Learn more](/stream/encoding) [Learn more](/api-reference/stream/manage-videos/get-video-storage-size-info)
</Update>
