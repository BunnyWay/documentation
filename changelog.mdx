...
This release makes playback smoother and more reliable everywhere. Enhancements include upgraded media-chrome, improved Firefox H.265 seeking, better Chromecast sync, and refined French UI translations. [Learn more](/stream/player)
...
Upgraded Smart feature language model to v5.4 for higher quality generation. JIT watermarking is now more reliable, and the cleanup endpoint supports MP4 removal. [Learn more](/api-reference/stream/manage-videos/cleanup-unconfigured-resolutions#parameter-delete-mp4-files)
