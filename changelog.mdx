...
<Update label="2026-03-27" tags={["Stream", "(Improvement)"]}>
  ## Free encoding improvements

Increased capacity and performance improvements to Stream Free encoding for faster transcoding and shorter queue times. [Learn more](/stream/encoding)

</Update>

<Update label="2026-03-26" tags={["Edge Scripting", "(Improvement)"]}>
  ## Node.js file system API is now generally available

The `node:fs` API in Edge Scripts has graduated from Preview and is now generally available, with the virtual file system memory limit removed. [Learn more](/scripting/node/fs/node-fs)
