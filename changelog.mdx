...
<Update label="2026-07-09" tags={["Storage","(Improvement)"]}>
  ## Storage overview and quickstart now feature S3-Compatible API

  The Storage overview and quickstart pages now prominently link to the S3-Compatible API documentation, and the quickstart reflects the updated public preview status for S3 compatibility. [Learn more](/storage/quickstart)
</Update>
