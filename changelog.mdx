...
<Update label="2026-06-02" tags={["Platform", "(New)"]}>
  ## Platform Domains reference page

  A new reference page listing all bunny.net domains and base URLs in one place, covering application URLs, CDN hostnames, database connection URLs, and platform API base URLs. [Learn more](/domains)
</Update>
