...
<Update label="2026-07-15" tags={["CDN","(Update)"]}>
  ## Default Pull Zone limit reduced to 500

  The default maximum number of Pull Zones per account has been reduced from 1,000 to 500. This limit can still be increased upon request by contacting support. [Learn more](/cdn/limits)
</Update>
