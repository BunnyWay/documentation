...
<Update label="2026-04-19" tags={["Storage","(Improvement)"]}>
  ## S3 API 'Closed Preview'

  Added support for 4 new S3 Storage Zone regions: London (UK), Stockholm (SE), Los Angeles (US), and Johannesburg (ZA).
</Update>
