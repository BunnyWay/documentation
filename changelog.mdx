...
<Update label="2026-04-21" tags={["Magic Containers", "(Improvement)"]}>
  ## Support for CDN endpoints with ClickHouse

Magic Containers now supports CDN endpoints for ClickHouse, allowing users to expose ClickHouse's HTTP interface through bunny.net's edge network with HTTPS. This enhancement provides more flexibility in connecting to ClickHouse externally. [Learn more](/magic-containers/guides/clickhouse)
