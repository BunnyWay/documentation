...
<Update label="2026-01-23" tags={["Stream","(New)"]}>
  ...
  Automatically generate chapters for your videos using AI. Smart Chapters analyzes your video's caption track to create chapter markers. [Learn more](/stream/smart-generate)
</Update>
