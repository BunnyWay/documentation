...
<Update label="2026-06-18" tags={["Magic Containers", "(Improvement)"]}>
  ## Magic Containers outbound connections limit

  The Magic Containers resource limits now include a 500 outbound connections limit per application. [Learn more](/magic-containers/limits)
</Update>
