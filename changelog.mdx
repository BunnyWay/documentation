...
<Update label="2026-07-13" tags={["CLI","(Improvement)"]}>
  ## GitHub repository link added to CLI docs

  The CLI documentation homepage now includes a direct link to the [BunnyWay/cli GitHub repository](https://github.com/BunnyWay/cli), making it easier to browse the source code, follow releases, and report issues. [Learn more](/cli)
</Update>
