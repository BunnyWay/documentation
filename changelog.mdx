...
<Update label="2026-07-27" tags={["Magic Containers","(Improvement)"]}>
  ...
  The Blue/Green deployment strategy guide now includes complete Terraform resource definitions for both blue and green container apps, uses proper resource references instead of placeholder IDs, and adds a routing tier configuration block. [Learn more](/magic-containers/deployment-strategies)
</Update>
