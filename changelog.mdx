...
<Update label="2026-04-28" tags={["Shield", "(New)"]}>
  ## API Guardian
...
<Update label="2026-04-28" tags={["Stream", "(Improvement)"]}>
...
<Update label="2026-04-28" tags={["Storage", "(Improvement)"]}>
  ## S3 API enhancements
...
<Update label="2026-04-28" tags={["Stream", "(New)"]}>
  ## Vimeo2Bunny CLI
...
<Update label="2026-04-28" tags={["Database", "(New)"]}>
  ## Database Shell
...
<Update label="2026-04-28" tags={["Magic Containers", "(New)"]}>
  ## Templates
...
JA4 TLS fingerprinting is now available on all pull zones. Identify clients based on their TLS handshake characteristics. [Learn more](/cdn/edge-rules/pattern-matching)
