...
<Update label="2026-06-25" tags={["Shield", "WordPress", "(New)"]}>
  ## Bunny Shield support in the WordPress plugin

  The WordPress plugin integration guides now cover Bunny Shield, including how to enable WAF and DDoS protection directly from the plugin. The WordPress documentation has also been restructured with a dedicated Bunny DNS and CDN Acceleration prerequisite guide and separate pages for Offloader and Shield setup. [Learn more](/integrations/wordpress/shield)
