...
<Update label="2026-03-26" tags={["CDN", "(New)"]}>
  ## JA4 fingerprinting

JA4 TLS fingerprinting is now available on all pull zones, allowing client identification based on TLS handshake characteristics. [Learn more](/cdn/security/ja4-fingerprinting)
...
<Update label="2026-03-26" tags={["Magic Containers", "(Improvement)"]}>
  ## Persistent Volumes GA

Persistent Volumes are now generally available with updated throughput limits and improved documentation. [Learn more](/magic-containers/persistent-volumes)

</Update>

<Update label="2026-03-26" tags={["Stream", "(Improvement)"]}>
...
<Update label="2026-03-26" tags={["Stream", "(New)"]}>
  ## Vimeo2Bunny CLI
...
<Update label="2026-03-26" tags={["Database", "(New)"]}>
  ## Database Shell
...
<Update label="2026-03-26" tags={["Magic Containers", "(New)"]}>
  ## Templates
...
<Update label="2026-03-26" tags={["Edge Scripting", "(New)"]}>
