...
<Update label="2026-06-05" tags={["AI Image Generation", "(Removed)"]}>
  ## AI Image Generation removed

The Bunny AI Image Generation product and its documentation have been removed. This includes the introduction, quickstart, reference, and pricing pages.
