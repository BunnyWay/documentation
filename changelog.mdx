...
<Update label="2026-06-23" tags={["Shield", "(New)"]}>
  ...
  Bunny Shield now supports Custom Response Pages, allowing you to fully customize the challenge, block, and rate limit pages shown to visitors. Replace generic protection pages with branded HTML experiences that match your website's look and feel. Available on Advanced and higher Bunny Shield plans. [Learn more](/shield/custom-response-pages)
