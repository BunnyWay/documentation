...
<Update label="2026-04-28" tags={["Home", "(New)"]}>
  ## API Guardian
...
Playback is now smoother and more reliable with upgrades to media-chrome, improved Firefox H.265 seeking, and enhanced Chromecast sync. Additional improvements include better iOS fullscreen transitions, early-play and JIT video starts, and expanded RUM monitoring. [Learn more](/stream/player)
...
The Smart feature language model has been upgraded for higher quality generation, and JIT watermarking is now more reliable. The cleanup endpoint now supports MP4 removal. [Learn more](/api-reference/stream/manage-videos/cleanup-unconfigured-resolutions#parameter-delete-mp4-files)
...
The transcribing language model has been upgraded to v1.2.0 for faster and higher quality transcriptions. [Learn more](/stream/transcribing)
