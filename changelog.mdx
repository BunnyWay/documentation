...
<Update label="2026-06-21" tags={["Billing", "(Improvement)"]}>
  ## Trial credit expiration clarifications

  Updated the billing, quickstart, and FAQ documentation to clarify that trial credits expire at the end of the 14-day trial period and unused balances are not carried over. A new FAQ entry explains what happens to trial credits when the trial ends. [Learn more](/billing/add-funds#minimum-monthly-usage)
