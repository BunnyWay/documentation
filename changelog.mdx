...
<Update label="2026-06-17" tags={["Magic Containers", "(New)"]}>
  ## Blue/Green & A/B Deployment Strategies

Magic Containers now has a deployment strategies guide covering Blue/Green, A/B, and Canary deployments. Run multiple versions of your app simultaneously and control how traffic is routed between them using pull zone origins or Edge Scripting. [Learn more](/magic-containers/deployment-strategies)

</Update>

<Update label="2026-06-17" tags={["Edge Scripting", "(New)"]}>
