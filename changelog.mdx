...
<Update label="2026-05-20" tags={["Stream","(Improvement)"]}>
  ...
  We've created and extended the 'Get Video Storage Size Info' endpoint, giving customers a granular, per-video breakdown of their storage consumption over API. This feature has been added to the Stream dashboard for granular video storage usage breakdown via the (i) infomation icon - selectable within your video library or your video page. [Learn more](/stream/encoding) [Learn more](/api-reference/stream/manage-videos/get-video-storage-size-info)
</Update>
