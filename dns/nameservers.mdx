...
To view your nameservers, go to **DNS**, select your DNS Zone, then click **Nameservers** in the zone menu. With the [bunny CLI](/cli), run `bunny dns zones nameservers example.com` to show them (custom nameservers if enabled, otherwise the defaults above).
