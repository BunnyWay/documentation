...
<Steps>
  <Step title="Create a new DNS Zone">
    ...
    <Frame>![](/images/dns/add-dns-zone.png)</Frame>
  ...
  <Step title="Review your records">
    ...
    <Info>Some records may not be detected automatically or could fail to import. Always verify against your current DNS provider before proceeding.</Info>
