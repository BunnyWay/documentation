---
title: "DNSSEC"
description: "Enable DNSSEC to protect your domain from DNS spoofing, cache poisoning, and man-in-the-middle attacks."
---
...
<Tabs>
  <Tab title="Dashboard">
    1. Enable DNSSEC within your DNS zone under the Security tab.

    ![](/images/docs/1a1983ec6cabed83a892ce54e7ed52f4b66bab6445737261b474ee75a3bc5f1b-image.png)

    2. Copy the DS Record provided after enabling.
    3. Add the DS Record through your domain registrar (see setup guides below).
  ...
  <Tab title="CLI">
    ...
    1. Enable DNSSEC on the zone. The command prints the DS record to register:

       ```bash
       bunny dns zones dnssec enable example.com
       ```

    2. Add the DS Record through your domain registrar (see setup guides below).

    To turn DNSSEC off again, run `bunny dns zones dnssec disable example.com` (confirms unless `--force`).
