...
- Generate signed tokens by from a string formed by concatenating:
  - `VideoLibraryApiKey`
  - `videoId`
...
Tokens should be **short-lived** (1–5 minutes recommended).
...
- Embed View Token Authentication is **mandatory** for private videos
- CDN Token Authentication is applied automatically by the SDK if turned on in the video library
