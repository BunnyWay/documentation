...
keywords: ["video", "spec", "specification", "audio", "bitrate", "codec", "upload", "ingest", "encode", "transcode", "ABR", "format", "container", "frames", "fps", "language code", "iso code", "mutliaudio", "multi audio", "multi-audio", "multiple audio", "stereo"]
---
...
- Premium and free encoding does not de-interlace your video, ensure your input video is progressive format and not interlaced before uploading
- No audio processing or effects are applied to your videos during encoding. This means the audio volume or loudness is not compressed or normalized and the audio original is preserved.
