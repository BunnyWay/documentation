...
<Warning>
On iOS devices, DRM-protected content only works in Safari. Other browsers on iOS (such as Chrome or Firefox) do not support FairPlay DRM and will display an error when attempting to play protected content.
</Warning>
