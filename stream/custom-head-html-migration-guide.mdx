...
This guide explains how to migrate custom `<head>` markup from the legacy Bunny Stream player (Plyr-based) to the new Bunny Stream Player.<br />It is based on typical customization patterns seen across customer integrations.
