...
<Update label="2026-06-08" tags={["Stream","(Improvement)"]}>
  ## Stream storage structure URLs

  The Stream storage structure reference has been updated with corrected URL domains, a new embed URL pattern, and expanded technical detail on player seek thumbnail sprites. [Learn more](/stream/storage-structure)
</Update>
