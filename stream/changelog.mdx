...
<Update label="2026-06-11" tags={["Stream","(Improvement)"]}>
  ## Stream embedding, encoding & storage structure documentation improvements

  Updated MP4 fallback documentation to reflect support for 240p, 360p, 720p & 1080p resolutions. Added direct play URL and embed URL examples with query parameters, documented the `-auto` captions flag, and improved cross-linking between Stream pages. [Learn more](/stream/storage-structure)
</Update>
