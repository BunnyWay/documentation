...
<Update label="2026-07-16" tags={["Stream","(Improvement)"]}>
  ...
  What this unlocks: eDRM videos can now be cast — Widevine-protected content plays on the TV, closing a long-standing gap vs the legacy player

  • A native-feeling TV experience — video title and thumbnail on screen, player colors and captions appearance (color, font, size) synced from the embed

  • Full playback control while casting — audio track selection works before and during casting, and playback rate changes apply on the TV
