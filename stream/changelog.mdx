...
<Update label="2026-07-03" tags={["Stream","(Improvement)"]}>
  ## Premium Encoding JIT input requirements, file preparation, and tooling guides

  The Premium Encoding documentation now includes detailed JIT (Just-in-Time) encoding guidance: required input file characteristics (container format, moov atom placement, metadata), recommended file preparation steps, and encoding instructions for HandBrake and FFmpeg. [Learn more](/stream/premium-encoding)
</Update>
