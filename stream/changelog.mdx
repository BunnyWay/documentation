...
<Update label="2026-06-08" tags={["Stream","(Improvement)"]}>
  ## Stream Storage Structure URL patterns

  The Storage Structure documentation now includes comprehensive URL patterns for default thumbnails, player seek thumbnails, and GIF preview animations, making it easier to programmatically access all video assets. [Learn more](/stream/storage-structure)
</Update>
