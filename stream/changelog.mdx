...
<Update label="2026-06-01" tags={["Stream","(Improvement)"]}>
  ## Smart Generate

  The Smart Chapters feature has been expanded and rebranded to Smart Generate. You can now automatically generate titles, descriptions, chapters, and moments for your videos using AI. [Learn more](/stream/smart-generate)
</Update>
...
<Update label="2026-01-23" tags={["New"]}>
  ...
  Automatically generate chapters for your videos using AI. Smart Chapters analyzes your video's caption track to create chapter markers, improving navigation for viewers. [Learn more](/stream/smart-generate)
</Update>