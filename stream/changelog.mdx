...
<Update label="2026-07-23" tags={["Stream","(Improvement)"]}>
  ## MediaCage DRM documentation restructure and eDRM security clarification

  The MediaCage DRM documentation has been reorganized into clear Basic DRM and Enterprise DRM sections for easier navigation. A new security notice clarifies that customizing the Bunny Player does not weaken core DRM protection, and explains that screen capture cannot be fully prevented on lower-security devices (e.g. Widevine L3), where playback is capped at SD quality (480p). The multi-key DRM licensing explanation for Enterprise DRM has also been corrected. [Learn more](/stream/drm/index)
</Update>
