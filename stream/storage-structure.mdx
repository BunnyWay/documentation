...
<Info>
  Direct play URL is ideal full screen experiences.
</Info>
...
Embed URL is best for embedding the video player into websites or browser experiences. It requires an iframe. [Read more about embedding videos here](/stream/embedding).
