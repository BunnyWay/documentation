...
<Note>
  [The signing secret is your library's **Read-Only API key**. Validation must use the **exact raw body** as received — do not parse and re-serialize the JSON body.](/api-reference/core/stream-video-library/get-video-library#response-read-only-api-key-one-of-0)
</Note>
...
- **signatureSecret**: Your library's [**Read-Only API key**](/api-reference/core/stream-video-library/get-video-library#response-read-only-api-key-one-of-0), encoded as UTF-8.
