...
<Info>
  Video storage usage can also be provided over aPI [https://docs.bunny.net/api-reference/stream/manage-videos/get-video-storage-size-info](https://docs.bunny.net/api-reference/stream/manage-videos/get-video-storage-size-info)
</Info>
