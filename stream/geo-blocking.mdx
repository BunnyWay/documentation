...
<Steps>
  ...
  <Step title="Choose your mode and add countries">
    ...
    As you add countries, they appear as markers on the map - green for allowlisted, red for blocked - so you can confirm your coverage at a glance. As soon as you add a country to one list, the other list is disabled, and the dropdown shows _Unavailable while allowlisting is in use_ or _Unavailable while blocking is in use_.
  </Step>
