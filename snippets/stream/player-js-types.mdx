The package ships without TypeScript types. Add a declaration file, for example `player.js.d.ts`, anywhere your `tsconfig.json` includes. It covers the methods and events the Bunny Player supports:
