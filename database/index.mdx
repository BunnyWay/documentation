...
- **Versioned migrations**: Track schema changes as SQL files and apply them with the Bunny CLI
...
<CardGroup cols={2}>
  ...
  <Card title="Migrations" icon="git-branch" href="/database/migrations">
    Version your schema as SQL files and apply them with the Bunny CLI
  </Card>
