...
| Stage                         | Access      | Pricing                          | Visibility            | Intended use                                    |
| ----------------------------- | ----------- | -------------------------------- | --------------------- | ----------------------------------------------- |
| **Closed Preview**            | Invite-only | Free                             | Not publicly promoted | Early validation with trusted users             |
| **Public Preview**            | Public      | Free or paid (varies by product) | Publicly announced    | Real-world and **limited production** workloads |
| **General Availability (GA)** | Public      | Paid                             | Full public launch    | **Production workloads with SLAs**              |
