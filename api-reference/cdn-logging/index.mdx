...
| --- | --- | --- |
| [v2](/cdn/logging/api-reference/query-logs) | JSON | Structured JSON with rich filtering, pagination, and per-field search. **Recommended.** |
| [v1](/cdn/logging/api-reference/query-logs-legacy) | Pipe-delimited | Streams a raw pipe-delimited file for a given day. Preserved for existing integrations. |
