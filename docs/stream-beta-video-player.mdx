...
You can also activate the beta player over API on your video library using the following **cURL commands** via the '**Update video library**' endpoint: [https://docs.bunny.net/reference/videolibrarypublic_update#/](/reference/videolibrarypublic_update#/)
...
[Player settings](/docs/stream-player-settings)
