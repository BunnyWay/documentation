...
Please keep in mind that for a video to be tagged, this option **has to be enabled** before you upload a video. In the case that you are curious about the more specific details of how Content Tagging works, we would recommend [reading this article.](/docs/stream-content-tagging)
...
- [Premium encoding](/docs/stream-premium-encoding)

- [Table of Contents](#)

- - [Where can I find these settings?](#where-can-i-find-these-settings)
  - [Understanding the options offered](#understanding-the-options-offered)
  - [Enabled Resolutions](#enabled-resolutions)
  - [Resolutions Bitrates](#resolutions-bitrates)
  - [Keep Original Files](#keep-original-files)
  - [Enable Early-Play](#enable-early-play)
  - [Enable Content Tagging](#enable-content-tagging)
  - [Enable MP4 Fallback](#enable-mp4-fallback)
  - [Enabled Resolutions](#enabled-resolutions-1)
  - [Watermark](#watermark)
  - [Why are my videos taking up more space than they should?](#why-are-my-videos-taking-up-more-space-than-they-should)
