...
- - [What you'll need](#what-youll-need)
  ...
  - [Creating a Ratelimit Rule](#creating-a-ratelimit-rule)

  - [Examples](#examples)

  - - [Rate limit request if a cookie is set with a specific value and exceeds a defined limit](#rate-limit-request-if-a-cookie-is-set-with-a-specific-value-and-exceeds-a-defined-limit)
    - [Rate limit request if User-Agent is a known crawler and exceeds a defined limit](#rate-limit-request-if-user-agent-is-a-known-crawler-and-exceeds-a-defined-limit)
