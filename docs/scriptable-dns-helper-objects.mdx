...
Returns the \[GeoLocation]\([https://docs.bunny.net/docs/getting-started#geolocation](/docs/getting-started#geolocation) result for the specified IP based on a GeoDNS database.
