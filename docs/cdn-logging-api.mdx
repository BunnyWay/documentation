...
<CodeGroup>
  ```bash bash https://logging.bunnycdn.com/{mm}-{dd}-{yy}/{pull_zone_id}.log
  ```
</CodeGroup>
...
<CodeGroup>
  ```bash bash AccessKey: bce1fd5a-a1da-464f-955e-9295201134f5 ```
</CodeGroup>
...
<CodeGroup>```bash bash Accept-Encoding: gzip ```</CodeGroup>
...
<CodeGroup>
  ```bash bash curl --location \ --request GET
