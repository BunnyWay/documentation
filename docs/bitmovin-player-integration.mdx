...
This documentation expands on our [player integration guide](/docs/integration-methods) to guide you through the integration of [Bitmovin Player](https://bitmovin.com/video-playe) with Bunny Stream’s video streams and MediaCage Enterprise DRM solution into your web application.
...
<CodeGroup>
  ...
  <html lang="en">
  <head>
      <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/bitmovin-player@8/bitmovinplayer-ui.css">
...
<CodeGroup>
          ...
          "preprocessHttpResponse": function (type, response) {
              switch (type) {
                  ...
                  case "manifest/hls/variant":
                      response.body = response.body.replace(/.*KEYFORMAT="com.apple.streamingkeydelivery"\n/, '')
                      break;
                  default:
                      break;
              }
  ...
  var source = {
      ...
      drm: {
          widevine: {
              LA_URL: "https://video.bunnycdn.com/WidevineLicense/{{videoLibraryId}}/{{videoId}}",
...
* * [What you’ll need](#what-youll-need)
  ...
  * [Setting up Bitmovin player](#setting-up-bitmovin-player)

    * [HTML configuration](#html-configuration)
    * [JavaScript configuration](#javascript-configuration)

  * [Finalizing integration](#finalizing-integration)
