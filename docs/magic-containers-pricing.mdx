...
If you have any questions, need guidance choosing the right pricing model, or require assistance estimating costs, please **contact our support team**. We’re here to help you navigate your options and ensure you get the most value out of Magic Containers.

---

[Limits](/docs/magic-containers-limits)

[Overview](/docs/edge-scripting-overview)

- [Table of Contents](#)

- - [Dynamic (shared) instances](#dynamic-shared-instances)
  - - [Cost components and rates](#cost-components-and-rates)
  - [Reserved instances (coming soon)](#reserved-instances-coming-soon)
  - [FAQ](#faq)
