---
title: "Widevine DRM Security Levels"
...
* * [Trusted Execution Environment (TEE)](#trusted-execution-environment-tee)
  ...
  * [Widevine DRM security levels explained](#widevine-drm-security-levels-explained)

    * [L1 security level](#l1-security-level)
    * [L2 security level](#l2-security-level)
    * [L3 security level](#l3-security-level)

  * [Supporting Widevine levels across devices](#supporting-widevine-levels-across-devices)

  * [Custom settings for content distribution](#custom-settings-for-content-distribution)
