...
- - [How are views counted?](#how-are-views-counted)
  - [Total views (ViewsChart)](#total-views-viewschart)
  - [Total watch time (WatchTimeChart)](#total-watch-time-watchtimechart)
  - [Views per country (CountryViewCounts)](#views-per-country-countryviewcounts)
  - [Watch time per country (CountryWatchTime)](#watch-time-per-country-countrywatchtime)
  - [Engagement score](#engagement-score)
  - [Heatmap](#heatmap)
  - [All stream statistics are available over stream API](#all-stream-statistics-are-available-over-stream-api)
