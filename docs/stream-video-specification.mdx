...
[Best practices](/docs/stream-best-practices)
...
- - [Guidelines](#guidelines)
  - [Supported input file containers](#supported-input-file-containers)
  - [Supported input codecs](#supported-input-codecs)
  - [Premium encoding outputs](#premium-encoding-outputs)
  - [Free encoding outputs](#free-encoding-outputs)
  - [Multi-audio support](#multi-audio-support)
  - [Caption support](#caption-support)
  - [Video file upload limits](#video-file-upload-limits)
