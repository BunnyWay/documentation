...
Update the api\_key with your actual API key in the configuration file, then initialize using the Terraform [Init command](https://developer.hashicorp.com/terraform/tutorials/cli/init).
...
* * [What you'll need](#what-youll-need)
  ...
  * [Initializing a Terraform project](#initializing-a-terraform-project)
    ...
    * [Starting from our template project](#starting-from-our-template-project)

  * [Defining the resources](#defining-the-resources)

  * [Previewing and applying the changes](#previewing-and-applying-the-changes)
