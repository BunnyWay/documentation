...
[Edge Rules variable expansion](/docs/edge-rules-variable-expansion)

[WebSockets](/docs/cdn-websockets)

- [Table of Contents](#)

- - [How Edge Rules Are Ordered](#how-edge-rules-are-ordered)

  - [Default Behavior: What Happens if No OrderIndex Is Set?](#default-behavior-what-happens-if-no-orderindex-is-set)

  - [Short-Circuiting vs. Multi-Action Execution](#short-circuiting-vs-multi-action-execution)

  - - [Example Behaviors](#example-behaviors)

  - [Cached vs Non-Cached Edge Rule Execution](#cached-vs-non-cached-edge-rule-execution)

  - [Setting the Execution Order](#setting-the-execution-order)

  - - [Method 1: Dashboard (Drag & Drop)](#method-1-dashboard-drag--drop)
    - [Method 2: API (Set OrderIndex Directly)](#method-2-api-set-orderindex-directly)
