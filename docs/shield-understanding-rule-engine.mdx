...
* **`GEO`** (*Optional* **Variable Value** - ***COUNTRY\_CODE, LATITUDE, LONGITUDE, ASN, CITY, CONTINENT***) (**Advanced**) The geo location information of the client making the request.
