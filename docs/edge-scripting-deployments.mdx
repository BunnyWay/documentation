...
[Environment variables and secrets](/docs/edge-scripting-environment-variables-and-secrets)

[Statistics and logs](/docs/edge-scripting-statistics-and-logs)

- [Table of Contents](#)

- - [Accessing the deployments view](#accessing-the-deployments-view)
  - [Publishing previous deployments](#publishing-previous-deployments)
