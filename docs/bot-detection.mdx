...
- - [Key Features](#key-features)
  - [Multi-layer request analysis](#multi-layer-request-analysis)
  - [Sensitivity profiles](#sensitivity-profiles)
  - [Granular detection toggles](#granular-detection-toggles)
