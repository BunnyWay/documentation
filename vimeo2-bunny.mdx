...
[**Vimeo2Bunny** Command Line Interface tool](https://www.npmjs.com/package/vimeo2bunny). Videos transfer directly from Vimeo to [bunny.net](http://bunny.net) via Fetch Video URL, nothing is downloaded to your machine.\
\
...
<Info>
  [If you don't have npx installed, follow this installation guide for node.js/npm.](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm$0)
</Info>
