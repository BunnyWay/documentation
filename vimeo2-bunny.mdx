...
Migrate videos from Vimeo to [**bunny.net**](http://bunny.net) [**Stream**](https://bunny.net/stream/)** with our 
**Vimeo2Bunny** Command Line Interace tool. Videos transfer directly from Vimeo to [bunny.net](http://bunny.net) via Fetch Video URL — nothing is downloaded to your machine.\
\
https://www.npmjs.com/package/vimeo2bunny
...
<Info>
  [If you don't have npx installed, follow our npx installation guide below.](#how-to-install-npx)
</Info>
