...
- **`GEO`** (_Optional_ **Variable Value** - **_COUNTRY_CODE, COUNTRY_CODE3, LATITUDE, LONGITUDE, ASN, CITY, CONTINENT, ORGANIZATION_**) (**Advanced**) The geo location information of the client making the request. With no Variable Value, returns all components.
...
- **`RESPONSE_BODY`** (**Premium**) The textual payload of the response body returned to the client.
