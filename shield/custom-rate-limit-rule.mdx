...
Rate limit rules let you cap how many requests a client can make to your application within a defined window. Combined with Bunny Shield's targeting controls, you can block abuse, slow brute-force attempts, and protect specific endpoints without affecting legitimate traffic.
