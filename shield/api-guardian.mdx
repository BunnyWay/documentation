...
- **Log** to record unmatched requests and let them continue to your origin.
- **Ignore** to bypass API Guardian entirely for unmatched paths.

Only **Ignore** lets an unmatched request reach the Managed WAF ruleset; under **Block** and **Log**, Managed WAF is skipped (this may change in the future). Other Shield features such as Rate Limiting and Bot Detection apply regardless of this setting.
