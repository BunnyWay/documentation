...
Bunny Shield surfaces both aggregated metrics and per-request logs so you can audit how the WAF Engine is treating your traffic, spot false positives, and tune your rulesets with confidence.
