...
> ## Documentation Index
>
> Fetch the complete documentation index at: [https://bunny.net/docs/llms.txt](https://bunny.net/docs/llms.txt) Use this file to discover all available pages before exploring further.
...
- Generate embed view token by following the [token authentication signing procedure](/docs/stream/token-authentication#signing-procedure) (token security key is your Video Library API Key)
