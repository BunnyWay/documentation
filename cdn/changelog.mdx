...
<Update label="2026-06-25" tags={["Improvement"]}>
  ...
  The SSL setup guide now covers automatic wildcard certificate issuance via Bunny DNS, ACME challenge passthrough to origin servers, and using Seamless Domain Migration for zero-downtime certificate provisioning before repointing your domain. [Learn more](/cdn/ssl-setup)
