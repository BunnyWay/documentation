...
<Card title="API Reference" href="/api-reference/core/pull-zone/request-external-dns-certificate">
...
<Card title="API Reference" href="/api-reference/core/pull-zone/complete-external-dns-certificate">
  View full endpoint documentation
</Card>
...
```bash
curl --request POST \
  --url https://api.bunny.net/pullzone/requestExternalHttpCertificate \
  --header 'AccessKey: YOUR_API_KEY' \
  --header 'Content-Type: application/json' \
  --data '
{
...
<Card title="API Reference" href="/api-reference/core/pull-zone/request-external-http-certificate">
  View full endpoint documentation
</Card>
...
```bash
curl --request POST \
  --url https://api.bunny.net/pullzone/completeExternalHttpCertificate \
  --header 'AccessKey: YOUR_API_KEY' \
  --header 'Content-Type: application/json' \
  --data '
{
...
<Card title="API Reference" href="/api-reference/core/pull-zone/complete-external-http-certificate">
  View full endpoint documentation
</Card>
