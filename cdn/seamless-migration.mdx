---
title: External DNS SSL Certificate Migration
...
<Step title="Point your domain to bunny.net">

After the certificate is issued, update your domain’s DNS records to point to bunny.net.
