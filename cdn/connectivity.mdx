...
While a significant portion of our infrastructure already operates in dual-stack mode, achieving full IPv6 coverage across more than 119 Points of Presence requires coordination with upstream providers and local network operators worldwide. Some locations currently operate in environments where native IPv6 connectivity is not yet available.
