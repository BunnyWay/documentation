...
```bash Upscale 1024x512 image to 2048x1024
https://yourzone.b-cdn.net/image.jpg?width=2048&upscaling=resampling
```

```bash Upscale 1024x512 image to 1536x768
https://yourzone.b-cdn.net/image.jpg?width=1536&height=768&upscaling=resampling
```

```bash Downscale 1024x512 image to 512x256. No upscaling (target is smaller than original).
