...
Presigned URLs require authentication. For publicly available presigned URLs without authentication please use [bunny.net](http://bunny.net) CDN by adding a pullzone to your storagezone. 
...
| ✅ `Presign` | ✅ expires-in<br />✅ Signing algorithm AWS4-HMAC-SHA256 |
...
8. **Set presigned URL expiry time** in seconds i.e