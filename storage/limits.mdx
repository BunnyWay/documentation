---
title: Limits
description: Connection limits and rate limits for Bunny Storage API and FTP access
---
...
If you continue to hit these limits, contact support. We can increase limits on a case-by-case basis for high-volume use cases.
