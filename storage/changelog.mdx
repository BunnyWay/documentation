...
<Update label="2026-06-16" tags={["Storage","(Improvement)"]}>
  ## S3 compatibility available across all regions

  S3-compatible storage zones are no longer limited to specific regions. The previous restriction to Frankfurt, New York, and Singapore has been lifted. [Learn more](/storage/s3)
</Update>
