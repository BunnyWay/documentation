...
<Warning>
  ...
  when other upload options are not available. Use the [HTTP
  API](/storage/http-api) for better security and performance.
</Warning>
...
- [HTTP API](/storage/http-api) - Recommended for programmatic uploads
- [S3-compatible API](/storage/s3-api) - Use familiar S3 tools
