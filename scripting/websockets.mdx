---
title: WebSockets
description: Use WebSockets in an Edge Script for two-way, low-latency communication between your script and connected clients.
---
...
- [Server-Sent Events](./server-sent-events), for one-way streaming from the script to the client
