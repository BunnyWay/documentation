...
The smallest possible monthly Scripting charge is $0.22: the first CPU Time increment ($0.02) plus the first Requests increment ($0.20). You will see this amount as soon as you begin testing a script, and it will not increase until you pass 1,000,000 requests or 1000s of CPU time. See [Example 1: Minimum usage](#example-1-minimum-usage).
