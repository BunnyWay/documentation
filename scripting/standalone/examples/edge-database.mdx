...
description: "Bunny Edge Scripting makes it easy to integrate with edge databases like . This allows you to bring dynamic data capabilities to your applications directly at the edge, enabling faster responses and reducing latency for your users."
---
...
- @return {Response} The HTTP response or string.
  ...
  var userResults = await turso.execute("SELECT _ FROM users WHERE email = '[email protected]'");
...
[Modify response body (Middleware)](/docs/script-example-modify-body)
```
