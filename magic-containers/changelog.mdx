...
<Update label="2026-07-09" tags={["Update"]}>
  ## Persistent volume billing is now active

  Persistent volume pricing is now in effect at $0.10 per GB/month, charged based on allocated volume size. Volumes are billed while they exist, even when detached from a container. [Learn more](/magic-containers/persistent-volumes#pricing)
</Update>
