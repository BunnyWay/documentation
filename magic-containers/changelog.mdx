...
A new deployment strategies guide covering Blue/Green, A/B, and Canary deployments. Run multiple versions of your app simultaneously and control how traffic is routed between them using pull zone origins or Edge Scripting. [Learn more](/magic-containers/deployment-strategies)
