...
<Update label="2026-06-18" tags={["Improvement"]}>
  ## Outbound connections limit

  The resource limits now include a 500 outbound connections limit per application. [Learn more](/magic-containers/limits)
</Update>
