...
<Update label="2026-07-30" tags={["Improvement"]}>
  ...
  The per-account application limit for Standard (production) accounts has been raised from 10 to 20, giving you more room to deploy applications without needing to contact support. [Learn more](/magic-containers/limits)
</Update>
