...
- **Design for graceful shutdown** - Stateful applications like databases should handle signals to ensure data integrity. Complete any pending writes and close connections before exiting.
