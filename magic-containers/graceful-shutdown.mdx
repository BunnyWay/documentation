...
<Warning>
Applications created before this default was introduced may have a 1-second grace period. To check or update your application's grace period, use the `terminationGracePeriodSeconds` field via the API (`PUT /apps/APP_ID/`).
</Warning>
