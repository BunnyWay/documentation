...
gVisor implements a subset of Linux system calls. While most common applications work without modification, some workloads that rely on specialized or less common syscalls may experience compatibility issues.

If your application depends on specific Linux syscalls, we recommend testing thoroughly before deployment. Applications using standard networking, file I/O, and process management typically work without issues.
