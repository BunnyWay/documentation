...
[Region provisioning and latency optimization](/docs/magic-containers-region-provisioning-and-latency-optimization)

[Sandboxing containers](/docs/magic-containers-sandboxing-containers)

- [Table of Contents](#)

- - [The importance of health checks](#the-importance-of-health-checks)
  - [Health check types](#health-check-types)
  - [Monitoring your application's pulse](#monitoring-your-applications-pulse)
