...
<Note>
Throughput limits are shared across all volumes attached to an instance. For example, if an instance has two volumes, the combined read throughput for both volumes is 10 MB/s.
</Note>
