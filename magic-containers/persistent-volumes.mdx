...
<Note>
Throughput limits are shared across all volumes attached to a [pod](/magic-containers/multi-container) (instance). For example, if a pod has two volumes, the combined read throughput for both volumes is 10 MB/s.
</Note>
