...
<Note>
  Both containers share the same localhost network, so your app connects to Redis at `127.0.0.1:6379`. See [multi-container apps](/magic-containers/multi-container) for more details.
</Note>
