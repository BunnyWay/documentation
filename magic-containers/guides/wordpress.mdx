...
<Steps>
  <Step title="Browse templates">
    In the bunny.net dashboard, go to **Magic Containers** and select [**Templates**](https://dash.bunny.net/magic-containers/templates).
  </Step>
  <Step title="Select WordPress">
    Click [**WordPress**](https://dash.bunny.net/magic-containers/templates/wordpress-0) from the Apps section.
  </Step>
...
Once your app is running, open the endpoint URL in your browser. WordPress will display the installation wizard where you can:
...
3. Update the WordPress **Site URL** and **Home** settings under **Settings > General** to match your custom domain
