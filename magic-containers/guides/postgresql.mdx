...
<Steps>
  <Step title="Create a new app">
    ...
    Databases should use single region deployment because each region gets its own independent volume with no data replication between them. Multi-region deployment would result in separate, isolated databases per region.
