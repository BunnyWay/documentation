...
The following I/O limits apply per [pod](/magic-containers/multi-container) (instance) and are shared across all [persistent volumes](/magic-containers/persistent-volumes) attached to it:
