...
<Warning>
  This means applications with persistent volumes will experience brief downtime during a rolling update, as the old pod must release the volume before the new pod can attach it.
</Warning>
