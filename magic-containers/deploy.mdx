...
<Steps>
  <Step title="Open the Deploy App page">
    ...
    <Frame>
      ![Deploy App page in Magic Containers](/images/magic-containers/deploy-app.png)
    </Frame>
  ...
  <Step title="Select a container image">
    ...
    <Frame>
      ![Container configuration with image, endpoints, volumes, and environment variables](/images/magic-containers/deploy-app-container.png)
    </Frame>
