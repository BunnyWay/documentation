...
<Steps>
  ...
  <Step title="Configure Region Settings">
    ...
    - **Base region**: Regions where your app will always be deployed. You must select at least one base region. Standard accounts have no maximum, while trial accounts are limited to three regions. See [Limits](/magic-containers/limits#trial-accounts).
  ...
  <Step title="Configure instances and add container">
    Set the minimum and maximum number of instances (maximum is 10 per region on a standard account, 3 on a [trial account](/magic-containers/limits#trial-accounts)), and click **Add New Container**.
