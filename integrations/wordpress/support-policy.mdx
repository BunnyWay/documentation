...
sidebarTitle: "Support Policy"
description: "Support policy for the bunny.net WordPress plugin covering plugin versions, PHP, and WordPress compatibility."
---
...
| -------------- | -------------------- | ---------------- |
| 3.1.x          | 2026-06-25           | Today + 6 Months |
| 3.0.x          | 2026-03-12           | 2026-12-25       |
...
| PHP Version   | Support for 3.1.x | Support for 3.0.x | Support for 2.3.x | Support for 2.2.x |
| ------------- | ----------------- | ----------------- | ----------------- | ----------------- |
| 8.5           | Yes               | Yes               | Yes               | No                |
| 8.4           | Yes               | Yes               | Yes               | Yes               |
| 8.3           | Yes               | Yes               | Yes               | Yes               |
...
| WordPress Version | WP Release Date | Support for 3.1.x | Support for 3.0.x | Support for 2.3.x | Support for 2.2.x |
| ----------------- | --------------- | ----------------- | ----------------- | ----------------- | ----------------- |
| 7.1               | 2026-08-19      | Yes               | Yes               | Yes               | -                 |
| 7.0               | 2026-05-20      | Yes               | Yes               | Yes               | -                 |
| 6.9               | 2025-12-02      | Yes               | Yes               | Yes               | -                 |
| 6.8               | 2025-04-15      | No                | No                | Yes               | Yes               |
| 6.7               | 2024-11-12      | No                | No                | Yes               | Yes               |
| 6.6               | 2024-07-16      | No                | No                | No                | Yes               |
| 6.5               | 2024-04-02      | No                | No                | No                | Yes               |
| 6.4 and below     | 2023-11-07      | No                | No                | No                | No                |
