...
<Info>
  ...
  hardcoding your API key. See [Authentication](/terraform/authentication) for
  more options.
</Info>
...
<CardGroup cols={2}>
  <Card title="Resources" icon="box" href="/terraform/resources">
    Explore all available Terraform resources
  </Card>
  <Card title="Data Sources" icon="database" href="/terraform/data-sources">
    Query existing bunny.net resources
  </Card>
  <Card title="Authentication" icon="key" href="/terraform/authentication">
